...
namespace Settings {
    ...
    bool                    recording       =  1;
    bool                    flip_shader     =  0;
    const bool              libx264         =  1;  // | 0 = h264_mf | 1 = libx264 | libx264 is a software encoder optimized for size and quality (can produce same as h264_mf for half the size). h264_mf is a hardware encoder designed for speed and low CPU use.
    // h264_mf
