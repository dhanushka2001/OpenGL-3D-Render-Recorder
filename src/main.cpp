...
int main()
{
    ...
    glCompileShader(fragmentShader); // The GPU can't understand the source code so have to compile right now to machine code
    // check for shader compile errors
   ...
   // positions         // colors
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // -------------------------------------------------------------------------------
        glfwSwapBuffers(window); // instructs the GPU to discard the currently rendered frame and render the next one
        glfwPollEvents();
    }
